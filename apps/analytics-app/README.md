...
This example is basically an API for some event manager application. It provides a possibility to perform sign up users, confirm user's emails, manage user's events.
